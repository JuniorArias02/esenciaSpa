...
<head>
    ...
    <link rel="stylesheet" href="../resources/style/nuestrosServicios.css">
...
<body>
    ...
    <div class="contenido">
        ...
        <div class="contenido-cuerpo">
            <div class="contenido-titulo" id="nuestros_Servicios">
                <h1 class="roboto-black">NUESTROS SERVICIOS</h1>
            </div>
            <div class="contenido-info">
                <div class="info-left">
                    <div class="carta">
                        <div class="carta-image">
                            <img src="../resources/img/5.png" alt="" sizes="" srcset="" class="imagen-contenido">
                        </div>
                        <div class="carta-titulo">
                            <h2 class="roboto-bold texto-cuerpo">TRATAMIENTOS FACIALES</h2>
                        </div>
                    </div>
                    <div class="carta">
                        <div class="carta-image">
                            <img src="../resources/img/6.png" alt="" srcset="" class="imagen-contenido">
                        </div>
                        <div class="carta-titulo">
                            <h2 class="roboto-bold texto-cuerpo">TRATAMIENTO TERAPEUTICO Y BIENESTAR</h2>
                        </div>
                    </div>
                </div>
                <div class="info-right">
                    <div class="carta">
                        <div class="carta-image">
                            <img src="../resources/img/TratamientosCorporales.png" alt="" sizes="" srcset="" class="imagen-contenido">
                        </div>
                        <div class="carta-titulo">
                            <h2 class="roboto-bold texto-cuerpo">TRATAMIENTOS CORPORALES</h2>
                        </div>
                    </div>
                    <div class="carta">
                        <div class="carta-image">
                            <img src="../resources/img/Post-ooperatorios.png" alt="" srcset="" class="imagen-contenido">
                        </div>
                        <div class="carta-titulo">
                            <h2 class="roboto-bold texto-cuerpo">TRATAMIENTO POST-OPERATORIOS</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="contenido-cuerpo">
        <div class="contenido-titulo" id="tratamiento_faciales">
            <h2 class="roboto-black ">TRATAMIENTOS FACIALES</h2>
        </div>
        <div class="contenido-tratamientos">
            <div class="contenido-tratamientos-left">
                <div class="carta-tratamiento">
                    <div class="carta-image">
                        <img src="../resources/img/4.png" alt="" srcset="" class="imagen-contenido">
                        <div class="carga-imagen-texto">

                        </div>
                    </div>
                    <div class="carta-titulo ">
                        <h2 class="roboto-bold texto-cuerpo">LIMPIEZA FACIAL PRODUNDA</h2>
                    </div>
            ...
            <div class="contenido-tratamientos-center">
                <div class="carta-tratamiento">
                    <div class="carta-image">
                        <img src="../resources/img/4.png" alt="" srcset="" class="imagen-contenido">
                    </div>
            ...
            <div class="contenido-tratamientos-right">
                <div class="carta-tratamiento">
                    <div class="carta-image">
                        <img src="../resources/img/4.png" alt="" srcset="" class="imagen-contenido">
                    </div>
        ...
        <div class="contenido-cuerpo">
            <div class="contenido-titulo" id="tratamiento_corporales">
                <h2 class="roboto-black ">TRATAMIENTOS CORPORALES</h2>
            </div>
            <div class="contenido-tratamientos">
                <div class="contenido-tratamientos-left">
                    <div class="carta-tratamiento">
                ...
                <div class="contenido-tratamientos-center">
                    <div class="carta-tratamiento">
                        ...
                        <div class="carta-titulo ">
                            <h2 class="roboto-bold texto-cuerpo">PACK BODY REDUN</h2>
                        </div>
                        <div class="contexto-servicio">
                            <p class="roboto-light">
            ...
            <div class="contenido-cuerpo">
                <div class="contenido-titulo" id="tratamiento_bienestar">
                    <h2 class="roboto-black ">TRATAMIENTOS TERAPEUTICOS Y DE BIENESTAR</h2>
                </div>
                <div class="contenido-tratamientos">
                    <div class="contenido-tratamientos-left">
                        <div class="carta-tratamiento">
                ...
                <!-- Contenido OPERATORIOS -->
                <div class="contenido-Post">
                    <div class="contenido-cuerpo" id="tratamiento_postOperatorio">
                        <h2 style="text-align: center; " class="roboto-black">TRATAMIENTOS OPERATORIOS</h2>
                    </div>
                    <div>
                        <p class="texto-Normal roboto-light" style="text-align: center; font-size: 30px;">
                            Cuando decides realizarte una cirugía plástica, debes tener en cuenta que es de gran
                            importancia disponerse con anterioridad para dicho procedimiento, tanto emocional como
                            físicamente, y un manejo adecuado posterior a la cirugía...
                        </p>
                    </div>
                </div>
        ...
        <!-- Contenido PRE-OPERATORIO -->
        <div class="pre-operatorio">
            ...
            <div class="pre-contenido">
                ...
                <p class="roboto-light">
                    ...
                    antes
                    de la cirugía plástica. Este tratamiento puede incluir evaluaciones médicas, pruebas de
                    laboratorio
                    y medidas específicas para optimizar el estado de salud del paciente antes del procedimiento.
                </p>
            </div>
        </div>

        <!-- Contenido POST-OPERATORIO -->
        <div class="post-operatorio">
            <div class="post-ope-image">
                <img src="../resources/img/4.png" alt="" srcset="" style="max-width: 100%;">
            </div>
            <div class="post-contenido">
                <h2 class="roboto-bold">TRATAMIENTOS POST-QUIRÚRGICOS</h2>
                <p class="roboto-light">
                    La intervención terapéutica post-quirúrgica es crucial para el proceso de recuperación después
                    de la
                    cirugía plástica. Este tratamiento puede incluir cuidados de heridas, seguimiento médico y
                    recomendaciones específicas para garantizar una recuperación exitosa.
                </p>
            </div>
        </div>
