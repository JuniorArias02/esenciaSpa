...
<body>
    ...
    <div class="contenido">
        <div class="contenido-inicio">
            <img src="../resources/img/Imagen_horizontal.jpg" alt="" srcset="" class="imagen-contenido">
        </div>
        <div class="contenido-cuerpo">
            <p class="texto-Normal roboto-light ">
                "Ofrecemos todo tipo de servicio de tratamientos terapéuticos y de belleza
                de la mejor calidad para que luzcas una piel saludable en manos de profesionales".
            </p>
        </div>
        <div class="contenido-bienvenida">
            <div class="contenido-bienvenida-texto">
                <h1 class="roboto-bold texto-grande">BIENVENIDOS A ESENCIA SPA</h1>
            </div>
            <img src="../resources/img/lineacorazon.svg" alt="" srcset="">
            <p class="subTexto roboto-light">"Especialistas en el cuidado de tu piel"</p>
        </div>
